...
class transitionOption extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			...
			<div className="demo-container">
				<select name="" id="" className="js--animations" onChange={this.handleTransitionChange}>
					...
					<optgroup label="Bouncing Entrances">
						...
						<button onClick={this.onPreviewClick} className="demo js--triggerAnimation">Preview</button>
					</div>
		)
	}
}

module.exports = transitionOption
